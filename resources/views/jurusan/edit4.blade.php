  ...
  <div class="lg:flex gap-5 mx-auto mt-56">
        ...
        <div class="card w-96 bg-green-600 shadow-xl mx-auto mt-8">
            ...
            <p class="text-center">EDIT JURUSAN</p>
                  ...
                  @csrf
                      <h1>Jurusan</h1>
                    	<input type="text" name="nama_jurusan" value="{{ $jurusan->nama_jurusan }}" placeholder="nama_jurusan" class="input input-bordered w-full max-w-xs text-white" />
                      <h1>Singkatan Jurusan</h1>
                    	<input type="text" name="singkatan_jurusan" value="{{ $jurusan->singkatan_jurusan }}" placeholder="singkatan_jurusan" class="input input-bordered w-full max-w-xs text-white" />
