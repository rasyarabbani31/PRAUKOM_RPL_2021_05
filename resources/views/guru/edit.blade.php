...
<div class="navbar bg-green-600">
  ...
  <div class="navbar-center hidden lg:flex z-10">
    ...
    <div class="navbar-end">
      <a class="btn bg-red-400 text-white" href="">LOGOUT</a>
    </div>
  </div>
</div>
        ...
        <div class="card w-96 bg-green-600 shadow-xl text-primary-content mx-auto mt-8">
          <div class="card-body">
                  ...
                  @csrf
                      ...
                      <h1>Nama</h1>
                    	<input type="text" name="nama_guru" value="{{ $guru->nama_guru }}" placeholder="Nama Guru" class="input input-bordered w-full max-w-xs bg-white text-black" />
                      <h1>Jenis Kelamin</h1>
            		      <input type="text" name="jk_guru" value="{{ $guru->jk_guru }}" placeholder="Jk Guru" class="input input-bordered w-full max-w-xs bg-white text-black" />
                	<div class="card-actions justify-end">
