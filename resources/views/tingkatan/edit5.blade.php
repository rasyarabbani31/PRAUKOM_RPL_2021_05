    ...
    <div class="navbar-end">
      <a class="btn bg-red-400 text-black" href="">LOGOUT</a>
        ...
        <div class="card w-96 bg-green-600 shadow-xl mx-auto mt-8">
            ...
            <p class="text-center text-black">EDIT TINGKATAN</p>
		          <form action='/tingkatan/{{ $tingkatan->id }}' method='post'>
                  @method('PUT')

                  @csrf
                      <h1>Tingkatan</h1>
                    	<input type="text" name="tingkatan" value="{{ $tingkatan->tingkatan }}" placeholder="tingkatan" class="input input-bordered w-full max-w-xs bg-white" required/>
