          ...
          <table class="table w-full text-primary-content">
            ...
            @csrf
              ...
              <div class="input-group">
                <input type="search" placeholder="Cari Presensi Guru" name="katakunci" class="input input-bordered text-black bg-white" value="{{ Request::get('katakunci') }}" aria-label="Search" />
              ...
              <tr class="space-x-4 text-white text-center">
                  ...
                  <th class="text-black bg-white">Guru</th>
                  <th class="text-black bg-white">Keterangan Hadir</th>
                  <th class="text-black bg-white">Agenda KBM</th>
